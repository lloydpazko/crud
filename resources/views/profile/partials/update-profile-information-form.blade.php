<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="CivilStatus" :value="__('CivilStatus')" />
            <x-text-input id="CivilStatus" name="CivilStatus" type="text" class="mt-1 block w-full" :value="old('CivilStatus', $user->CivilStatus)" required autofocus autocomplete="CivilStatus" />
            <x-input-error class="mt-2" :messages="$errors->get('CivilStatus')" />
        </div>
